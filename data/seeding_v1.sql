...
INSERT INTO "stretch" ("id", "title", "description_content", "main_image", "description_image", "category_id") VALUES
    ...
    (14, 'Piriforme (pyramidal)','Allongé sur le dos, croiser une jambe sur l''autre : une cheville posée sur le genou de l''autre. Attraper la jambe d''appui en dessous et derrière le genou afin de la faire basculer au dessus du tronc.','https://i.ibb.co/7yHFd7f/14.webpF','', 8),
